...
p1     = xlsread('LSTM3.xlsx');
p2           =xlsread('CNN.xlsx');
p3     = xlsread('GRU.xlsx');
p4   = xlsread('BILSTM3.xlsx');
p5    =  xlsread('cnn-bilstm3.xlsx');
p6 = xlsread('cnn-gru3.xlsx');
...
hold off;
title('Comparison of Model Predictions ( Date 3 )','FontName','Times New Roman','FontAngle','italic');
