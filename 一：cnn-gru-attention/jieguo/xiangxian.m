...
p1     = xlsread('LSTM1.xlsx');
p2           =xlsread('CNN.xlsx');
p3     = xlsread('GRU.xlsx');
p4   = xlsread('BILSTM1.xlsx');
p5    =  xlsread('cnn-bilstm1.xlsx');
p6 = xlsread('cnn-gru1.xlsx');
...
hold off;
title('Comparison of Model Predictions ( Date 1 )','FontName','Times New Roman','FontAngle','italic');
