%EMD_VISU  visualization of EMD and partial reconstructions (fine to coarse & coarse to fine)EMD的可视化和部分重建(精细到粗，粗到细
%
% inputs :   - x : analyzed signal, if x is complex cemd_visu is called分析信号，如果x是复数，则调用cemd_visu
%            - t : time instants
%            - imf : output of emd.m
%            - i (optional) : figure number for display
%
% outputs :  - f2c : fine to coarse reconstruction细至粗重建
%            - c2f : coarse to fine reconstruction粗至细重建
%
%
% See also
